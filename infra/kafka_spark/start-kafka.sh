...
# Allow specific kafka_spark versions to perform any unique bootstrap operations
...
(
    ...
    # Fixes #312
    # KAFKA_VERSION + KAFKA_HOME + grep -rohe KAFKA[A-Z0-0_]* /opt/kafka_spark/bin | sort | uniq | tr '\n' '|'
